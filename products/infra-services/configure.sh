#!/usr/bin/env bash
# ==============================================================================
# Infrastructure Services Configuration Scaffold Module
# ==============================================================================
[[ -n "${_INFRA_SERVICES_CONFIGURE_LOADED:-}" ]] && return 0
_INFRA_SERVICES_CONFIGURE_LOADED=1
...
gather_infra_services_vars() {
    ...
    log_banner "THIẾT LẬP THÔNG SỐ DỊCH VỤ HẠ TẦNG (DNS/NTP)"
    ...
    prompt_if_placeholder "IP_INFRA_01" "Nhập IP tĩnh cho máy chủ Infra Services" "${PRODUCT_CONF}" || return 1
